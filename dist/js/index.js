 ...
 /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */            _regeneratorRuntime = function _regeneratorRuntime() {
        ...
        function initSliders() {
            if (document.querySelector(".quotes__slider")) {
                ...
                var mainSlaider = new swiper_core_Swiper(".hero__slider", {
                ...
                var miniSlider = new swiper_core_Swiper(".hero-mini__slider", {
                    modules: [ Navigation, Controller ],
                    loop: true,
                    observer: true,
                    observeParents: true,
            ...
            function pageNavigationAction(e) {
                if (e.type === "click") {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        var gotoSpeed = gotoLink.dataset.gotoSpeed ? gotoLink.dataset.gotoSpeed : 700;
        ...
        bg.addEventListener("resize", (function(e) {
            getComputedStyle(bg).top;
        }));
        function bgAdupt() {
            var block = document.querySelector(".hero__block");
            var bg = document.querySelector(".hero__bg");
            var bgTop = parseFloat(getComputedStyle(bg).top);
            var blockSize = block.offsetHeight;
            var amount = bgTop / blockSize * -100;
